...
import "./DigitalCallUserTermsKeeper.sol";
import "../../libraries/SafeERC20.sol";
import "../../interfaces/Digital/oasis/IDigitalCallBondDepositoryOasis.sol";
...
contract DigitalCallBondDepositoryOasis is IDigitalCallBondDepositoryOasis, DigitalCallUserTermsKeeper {
    ...
    function _bondAsset(
        ...
        (uint256 _index, int256 _fetchedPrice) = addTerms(_user, _market.underlying, _market.quote, _payout, _expiry, uint48(_marketId), _referral);

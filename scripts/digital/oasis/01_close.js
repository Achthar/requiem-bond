...
const BondDepositoryABI = require('../../../artifacts/contracts/bonds/oasis/DigitalCallBondDepository.sol/DigitalCallBondDepositoryOasis.json')
...
async function main() {
    ...
    const depoAddress = addresses.digitalCallBondDepo[chainId]

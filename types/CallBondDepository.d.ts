...
interface CallBondDepositoryInterface extends ethers.utils.Interface {
  functions: {
...
export class CallBondDepository extends BaseContract {
  ...
  interface: CallBondDepositoryInterface;

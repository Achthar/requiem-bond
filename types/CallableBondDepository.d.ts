...
interface CallableBondDepositoryInterface extends ethers.utils.Interface {
  functions: {
...
export class CallableBondDepository extends BaseContract {
  ...
  interface: CallableBondDepositoryInterface;

...
interface CallableBondDepositoryV02Interface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "callAll", values: [string]): string;
  ...
  decodeFunctionResult(functionFragment: "callAll", data: BytesLike): Result;
...
export class CallableBondDepositoryV02 extends BaseContract {
  ...
  interface: CallableBondDepositoryV02Interface;
  ...
  callStatic: {
    ...
    callAll(_user: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  filters: {
    ...
    "Bond(uint256,uint256,uint256,int256)"(

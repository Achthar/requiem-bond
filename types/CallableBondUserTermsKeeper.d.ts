...
interface CallableBondUserTermsKeeperInterface extends ethers.utils.Interface {
  functions: {
...
export class CallableBondUserTermsKeeper extends BaseContract {
  ...
  interface: CallableBondUserTermsKeeperInterface;

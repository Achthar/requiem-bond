...
interface CallableUserTermsKeeperInterface extends ethers.utils.Interface {
  functions: {
...
export class CallableUserTermsKeeper extends BaseContract {
  ...
  interface: CallableUserTermsKeeperInterface;

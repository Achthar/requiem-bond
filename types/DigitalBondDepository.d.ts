...
interface DigitalBondDepositoryInterface extends ethers.utils.Interface {
  functions: {
...
export class DigitalBondDepository extends BaseContract {
  ...
  interface: DigitalBondDepositoryInterface;

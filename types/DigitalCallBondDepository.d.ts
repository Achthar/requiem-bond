...
interface DigitalCallBondDepositoryInterface extends ethers.utils.Interface {
  functions: {
...
export class DigitalCallBondDepository extends BaseContract {
  ...
  interface: DigitalCallBondDepositoryInterface;

...
interface ICallBondDepositoryInterface extends ethers.utils.Interface {
  functions: {
...
export class ICallBondDepository extends BaseContract {
  ...
  interface: ICallBondDepositoryInterface;

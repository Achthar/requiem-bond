...
interface ICallableBondDepositoryInterface extends ethers.utils.Interface {
  functions: {
...
export class ICallableBondDepository extends BaseContract {
  ...
  interface: ICallableBondDepositoryInterface;

...
interface IDigitalBondDepositoryInterface extends ethers.utils.Interface {
  functions: {
...
export class IDigitalBondDepository extends BaseContract {
  ...
  interface: IDigitalBondDepositoryInterface;

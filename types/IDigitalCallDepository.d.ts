...
interface IDigitalCallDepositoryInterface extends ethers.utils.Interface {
  functions: {
...
export class IDigitalCallDepository extends BaseContract {
  ...
  interface: IDigitalCallDepositoryInterface;

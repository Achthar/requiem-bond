...
interface MockOracleInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: "refPice", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "refPice", data: BytesLike): Result;
...
export class MockOracle extends BaseContract {
  ...
  populateTransaction: {
    ...
    refPice(overrides?: CallOverrides): Promise<PopulatedTransaction>;

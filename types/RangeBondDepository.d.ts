...
interface RangeBondDepositoryInterface extends ethers.utils.Interface {
  functions: {
...
export class RangeBondDepository extends BaseContract {
  ...
  interface: RangeBondDepositoryInterface;

...
interface TargetBondDepositoryInterface extends ethers.utils.Interface {
  functions: {
...
export class TargetBondDepository extends BaseContract {
  ...
  interface: TargetBondDepositoryInterface;

...
interface TreasuryInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: "REQD", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "REQD", data: BytesLike): Result;
...
export class Treasury extends BaseContract {
  ...
  functions: {
    ...
    REQD(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    REQD(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    REQD(overrides?: CallOverrides): Promise<PopulatedTransaction>;

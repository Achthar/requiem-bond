...
interface UserRangeTermsKeeperInterface extends ethers.utils.Interface {
  functions: {
...
export class UserRangeTermsKeeper extends BaseContract {
  ...
  interface: UserRangeTermsKeeperInterface;

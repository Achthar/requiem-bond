...
interface UserTermsKeeperDigitalInterface extends ethers.utils.Interface {
  functions: {
...
export class UserTermsKeeperDigital extends BaseContract {
  ...
  interface: UserTermsKeeperDigitalInterface;

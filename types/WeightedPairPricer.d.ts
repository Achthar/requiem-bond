...
interface WeightedPairPricerInterface extends ethers.utils.Interface {
  functions: {
...
export class WeightedPairPricer extends BaseContract {
  ...
  interface: WeightedPairPricerInterface;
